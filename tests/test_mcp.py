...
from renderer.conftest import _spec_palette_hexes
...
# tests/renderer/test_colour.py::test_check_and_document_colors_merge_does_not_duplicate,
...
async def test_describe_mixes_match_spec_md(mcp):
    ...
    tests/renderer/test_colour.py::test_tiers_match_the_spec_headings; this test
...
# pinned for real in tests/renderer/test_swatches.py, against the real renderer.
